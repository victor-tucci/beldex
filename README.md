...
* If you would like a specific [version/tag](https://github.com/beldex-coin/beldex/tags), do a git checkout for that version. eg. '0.3.0'. If you dont care about the version and just want binaries from master, skip this step:
...
* Docker
        ...
        docker run -it -v /beldex/chain:/root/.beldex -v /beldex/wallet:/wallet -p 22020:22020 beldex

        # or in background
        docker run -it -d -v /beldex/chain:/root/.beldex -v /beldex/wallet:/wallet -p 22020:22020 beldex
